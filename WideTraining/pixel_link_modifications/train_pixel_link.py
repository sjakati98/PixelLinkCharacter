...
tf.app.flags.DEFINE_integer('train_image_width', 1280, 'Train image size')
tf.app.flags.DEFINE_integer('train_image_height', 720, 'Train image size')
...
def train(train_op):
    ...
    saver = tf.train.Saver(max_to_keep=5, write_version = 2)
    slim.learning.train(
            train_op,
